package com.shipmonk.testingday.rates.entity;

import com.shipmonk.testingday.rates.converter.RatesMapConverter;
...
@Table(name = "exchange_rate_snapshot",
        uniqueConstraints = @UniqueConstraint(columnNames = "rate_date"))
