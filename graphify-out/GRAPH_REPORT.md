...
## Corpus Check
- 31 files · ~27,248 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 274 nodes · 376 edges · 39 communities detected
- Extraction: 70% EXTRACTED · 30% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.8)
...
2. `FixerRatesResponse` - 16 edges
3. `ExchangeRatesIT` - 15 edges
4. `Graph Report Summary (153 nodes, 198 edges, 20 communities)` - 12 edges
5. `FixerExchangeRateProviderTest` - 10 edges
6. `ExchangeRatesService (Cache-Aside Logic)` - 10 edges
7. `RatesMapConverterTest` - 8 edges
8. `RatesResponse` - 8 edges
9. `ExchangeRateSnapshot` - 8 edges
10. `FixerClientTest` - 7 edges
...
- `Edge Case Handling Table (malformed date, future date, EUR rebase, concurrent writes, etc.)` --conceptually_related_to--> `Error Handling Constraint (Downstream Simplification)`  [INFERRED]
...
Cohesion: 0.09
Nodes (44): Community: Service Architecture, Community: Architecture Design Principles (cohesion 0.40), Community: Assignment Constraints (cohesion 0.50), Community: Fixer.io API Client (cohesion 0.50), Community: Persistence Infrastructure (cohesion 0.67), Community: Service Layer & Caching (cohesion 0.40), God Node: Expected Architecture Layers (Controller/Service/Repository/Client), God Node: ExchangeRateSnapshot (8 edges) (+36 more)

### Community 1 - "Community 1"
Cohesion: 0.15
Nodes (3): ExchangeRatesControllerTest, ExchangeRatesService, ExchangeRatesServiceTest

### Community 2 - "Community 2"
Cohesion: 0.11
Nodes (4): FixerApiException, FixerClient, FixerClientTest, FixerErrorDetail
...
Cohesion: 0.19
Nodes (2): FixerExchangeRateProvider, FixerExchangeRateProviderTest
...
- **Thin community `Community 27`** (2 nodes): `TestingdayExchangeRatesApplication`, `TestingdayExchangeRatesApplication.main`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (2 nodes): `Community: App Bootstrap & Tests`, `TestingdayExchangeRatesApplication`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (2 nodes): `Community: API Endpoint Controller`, `GET /api/v1/rates/{day} Endpoint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (1 nodes): `TestingdayExchangeRatesApplicationTests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `TestingdayExchangeRatesApplicationTests.contextLoads`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `GET /api/v1/rates/{day} Endpoint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `FixerErrorResponse DTO`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `Community: Caching & Data Layer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Community: Spring Boot App Entry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `PostgreSQL 14 via Docker Compose`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Hyperedge: Assignment Non-Functional Requirements (Architecture, Error Handling, No Auth)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `Rationale: No Auth Because Internal Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `FixerRatesResponse` connect `Community 6` to `Community 1`, `Community 2`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ExchangeRatesIT` connect `Community 3` to `Community 1`?**
