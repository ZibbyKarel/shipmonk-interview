...
## Corpus Check
- 49 files · ~27,460 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 241 nodes · 326 edges · 41 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 95 edges (avg confidence: 0.8)
...
7. `ExchangeRateSnapshot` - 9 edges
8. `ExchangeRatesControllerTest` - 8 edges
9. `ExchangeRatesServiceTest` - 7 edges
10. `GlobalExceptionHandler` - 7 edges
...
Cohesion: 0.11
Nodes (5): ExchangeRatesControllerTest, ExchangeRatesService, ExchangeRatesServiceTest, isHistorical(), isSuccess()
...
Cohesion: 0.13
Nodes (4): ErrorResponse(), isSuccess(), FixerExchangeRateProvider, FixerExchangeRateProviderTest
...
- **Thin community `Community 30`** (1 nodes): `FixerRatesResponse.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `ExchangeRates.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `FixerErrorDetail.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `FixerRatesResponse.java`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `GET /api/v1/rates/{day} Endpoint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `FixerErrorResponse DTO`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `Community: Caching & Data Layer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Community: Spring Boot App Entry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `PostgreSQL 14 via Docker Compose`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `Hyperedge: Assignment Non-Functional Requirements (Architecture, Error Handling, No Auth)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `Rationale: No Auth Because Internal Service`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ExchangeRatesIT` connect `Community 4` to `Community 0`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `ExchangeRateSnapshot` connect `Community 9` to `Community 0`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
