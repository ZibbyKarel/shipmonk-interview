...
## Corpus Check
- 26 files · ~23,286 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 218 nodes · 303 edges · 36 communities detected
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
...
Cohesion: 0.09
Nodes (6): ExchangeRatesController, ExchangeRatesControllerTest, ExchangeRateSnapshot, ExchangeRatesService, ExchangeRatesServiceTest, isHistorical()
